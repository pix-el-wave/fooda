...
import inha.capstone.fooda.domain.member.dto.PostConnectKakaoMemberReqDto;
import inha.capstone.fooda.domain.member.dto.PostConnectKakaoMemberResDto;
...
public class AuthController {
    ...
    public ResponseEntity<DataResponse<PostSignupMemberResDto>> signUp(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new DataResponse<>(PostSignupMemberResDto.of(memberId)));
    }
    ...
    public ResponseEntity<DataResponse<PostKakaoSignupMemberResDto>> kakaoSignup(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new DataResponse<>(PostKakaoSignupMemberResDto.of(jwtToken)));
    }
    ...
    public ResponseEntity<DataResponse<PostKakaoSigninMemberResDto>> kakaoSignin(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(new DataResponse<>(PostKakaoSigninMemberResDto.of(jwtToken, isUserSignedUp)));
    }
    ...
    public ResponseEntity<DataResponse<PostConnectKakaoMemberResDto>> connectKakao(
            @Validated @RequestBody PostConnectKakaoMemberReqDto request,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new DataResponse<>(PostConnectKakaoMemberResDto.of(true)));
    }
}
